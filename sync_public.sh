...
# Source Patches
git checkout HEAD -- src/c47/programming/input.c src/c47/programming/lblGtoXeq.c src/c47/screen.c src/c47/items.c src/c47/c47Extensions/graphText.c 2>/dev/null || true
